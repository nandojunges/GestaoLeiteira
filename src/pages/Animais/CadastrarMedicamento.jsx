...
export default function CadastrarMedicamento({ onFechar, onSalvar }) {
  ...
  const salvar = () => {
    ...
    const dadosSalvos = JSON.parse(localStorage.getItem("medicamentosSecagem") || "{}");
    dadosSalvos[nome] = { principio, leite, carne };
    localStorage.setItem("medicamentosSecagem", JSON.stringify(dadosSalvos));
