...
export default function ModalFiltroLoteInteligente({ vacas = [], medicoes = {}, onFechar, onAplicar }) {
  const [parametros, setParametros] = useState(() => {
    const salvos = localStorage.getItem("parametrosFiltroLote");
    return salvos
      ? JSON.parse(salvos)
      : {
  ...
  useEffect(() => {
    localStorage.setItem("parametrosFiltroLote", JSON.stringify(parametros));
  }, [parametros]);
